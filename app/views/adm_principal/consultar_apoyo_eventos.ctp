...
echo $javascript->link('adm_principal/consultar_apoyo_eventos');
?>
					...
					<td colspan="2">
						...
						<div>
							<table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody>
								...
								<tr><td height="10" /></tr>
								<tr align="left">
									<td class='subtitulo' width='80'>Buscar:</td>
								...
								<tr align="left">
									...
									<td>
										<select id="select_campo">
											...
											<option value="nombre">nombre del evento</option>
											<option value="lugar">lugar del evento</option>
											<option value="observaciones">observaciones</option>
											<option value="observaciones_solucion">observaciones de la solución</option>
										</select>
									</td>
								</tr>
								<tr align="left">
						...
						<div id='criterio_fecha'>
							<table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody>
								...
								<tr><td height="10" /></tr>
								<tr align="left">
									<td class='subtitulo' width='110'>Fecha del evento:</td>
										...
										<div id="fecha_anio_mes" style="display:block" class='div_busqueda'>
											<table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody>
												<tr align="left">
													...
													<td><select id="select_anio" name="data[Consulta][fecha][anio]"><?php echo $opciones_anios; ?></select></td>
												</tr>
												<tr><td height="10" colspan="4"/></tr>
												<tr align="left">
													<td class='subtitulo' width='70'>Mes:</td>
													<td><select id="select_mes" name="data[Consulta][fecha][mes]" disabled="true"><?php echo $opciones_meses; ?></select></td>
												</tr>
											</tbody></table>
										</div>
										...
										<div id="fecha_rango" style="display:none" class='div_busqueda'>
											<table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody>
												<tr align="left">
													...
													<td>
														<input id="fecha_inicial" name='data[Consulta][fecha][fecha_inicial]' type="text" readonly value='' maxlength="10" size='9' />
												...
												<tr align="left">
													...
													<td>
														<input id="fecha_final" name='data[Consulta][fecha][fecha_final]' type="text" readonly value='' maxlength="10" size='9' />
